...
import { ArrowLeft, ShoppingCart, Grid, List } from "lucide-react"
...
const categoryInfo = {
  res: {
    name: "Carnes de Res",
    description: "Los mejores cortes de res, seleccionados especialmente para tu parrilla",
    icon: "🥩",
  },
  cerdo: {
    name: "Carnes de Cerdo",
    description: "Cortes frescos y tiernos de cerdo de la mejor calidad",
    icon: "🐷",
  },
  pollo: {
    name: "Carnes de Pollo",
    description: "Pollo fresco de granja, criado naturalmente",
    icon: "🐔",
  },
  embutidos: {
    name: "Embutidos",
    description: "Embutidos artesanales y tradicionales",
    icon: "🌭",
  },
  ahumados: {
    name: "Productos Ahumados",
    description: "Carnes y pescados ahumados con técnicas tradicionales",
    icon: "🔥",
  },
  carbon: {
    name: "Carbón y Leña",
    description: "Todo lo necesario para tu parrilla perfecta",
    icon: "🪵",
  },
}
...
export default function CategoryPage({ params }: CategoryPageProps) {
  ...
  const categoryProducts = allProducts.filter((product) => product.category === params.slug)
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center justify-between">
            <p className="text-gray-600">
              {categoryProducts.length} producto{categoryProducts.length !== 1 ? "s" : ""} encontrado
        ...
        <div className="container mx-auto px-4">
          {categoryProducts.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-6">Pronto agregaremos más productos a esta sección</p>
              <Link href="/">
